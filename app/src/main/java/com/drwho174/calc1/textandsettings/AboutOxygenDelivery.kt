...
import com.drwho174.calc1.databinding.FragmentAboutOxygenDeliveryBinding
...
class AboutOxygenDelivery : Fragment(), HasCustomTitle {

    private var _binding : FragmentAboutOxygenDeliveryBinding? = null
    private val binding
        get() = _binding?: throw java.lang.IllegalStateException("_binding for AboutOxygenDeliveryFragment must not be null")

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentAboutOxygenDeliveryBinding.inflate(inflater,container,false)
        return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val markdowntext = binding.twAboutOxygenDelivery
