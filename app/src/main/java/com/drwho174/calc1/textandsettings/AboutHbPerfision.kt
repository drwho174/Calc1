...
import com.drwho174.calc1.databinding.FragmentAboutHbPerfisionBinding
...
class AboutHbPerfision : Fragment(), HasCustomTitle {
    private var _binding : FragmentAboutHbPerfisionBinding? = null
    private val binding
        get() = _binding?: throw java.lang.IllegalStateException("_binding for AboutHbPerfusionFragment must not be null")

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentAboutHbPerfisionBinding.inflate(inflater,container,false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val string = context!!.applicationContext
            .assets
            .open("about/Hb_On_Perfusion.md")
            .bufferedReader()
            .readText()

        val markdowntext = binding.twAboutHbPerfusion
